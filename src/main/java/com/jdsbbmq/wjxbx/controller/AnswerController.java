...
public class AnswerController {
    ...
    public List<Answer> selectQuestionnaireByPage(@RequestBody QueryRequest queryRequest) {
    ...
    public Integer selectAnswerCount(@RequestBody String questionnaireId) {
    ...
    public Answer selectAnswerById(@RequestBody String answerId) {
