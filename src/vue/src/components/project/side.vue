<template>
  <el-menu :default-active="activeMenu" class="menu" @select="handleMenuSelect">
    <el-button class="createButton" @click="createProject">
      <span id="plus">+</span>
      创建项目
    </el-button>
...
export default {
  ...
  methods: {
    ...
    createProject() {
      ...
      this.$emit('create', 'project'); // 通过事件向父组件传递创建项目的事件
    },
  },
};
</script>
...
.active-item {
  background-color: #dddddd; /* 设置选中时的背景颜色 */
  font-weight: bold; /* 设置选中时的字体加粗 */
  color: #000000;
}
